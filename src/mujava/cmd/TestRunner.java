...
public class TestRunner {
  ...
  static final boolean CLASS_MODE = true;
	...
	static TestResultParallel runTest(String targetClassName, String testSetName, int timeout_secs, boolean mode){
	...
	static TestResultParallel runClassTest(String targetClassName, String testSetName, int timeout_secs){
		return runTest(targetClassName,testSetName,timeout_secs,CLASS_MODE);
	}


	static TestResultParallel runTraditionalTest(String targetClassName, String testSetName, int timeout_secs){
