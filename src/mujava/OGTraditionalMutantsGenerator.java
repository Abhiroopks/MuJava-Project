...
public class OGTraditionalMutantsGenerator extends MutantsGenerator
{
   String[] traditionalOp;

   public OGTraditionalMutantsGenerator(File f) 
   {
      super(f);
      traditionalOp = MutationSystem.tm_operators;
   }
   
   public OGTraditionalMutantsGenerator(File f, boolean debug) 
   {
      super (f, debug);
      traditionalOp = MutationSystem.tm_operators;
   }
